...
case ${pyversion} in
    2.6|3.3)           maxversion=1.4;   maxnumpyversion=1.12; maxcythonversion=3.0 ;;
    3.2)               maxversion=1.4;   maxnumpyversion=1.12; maxcythonversion=0.27 ;;
    2.7|3.4)           maxversion=1.4;   maxnumpyversion=1.17; maxcythonversion=3.0 ;;
    3.5)               maxversion=1.4;   maxnumpyversion=1.19; maxcythonversion=3.1 ;;
    3.6)               maxversion=1.5.7; maxnumpyversion=1.20; maxcythonversion=3.1 ;;
    3.7|3.8|3.9|3.10)  maxversion=1.5.7; maxnumpyversion=1.22; maxcythonversion=3.1 ;;
    *)
