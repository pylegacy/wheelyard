...
case ${pyversion} in
    2.6)               maxversion=2.0; maxnumpyversion=1.12 ;;
    3.2)               maxversion=2.0; maxnumpyversion=1.12 ;;
    3.3)               maxversion=2.0; maxnumpyversion=1.12 ;;
    2.7|3.4)           maxversion=3.0; maxnumpyversion=1.17 ;;
    3.5)               maxversion=3.1; maxnumpyversion=1.19 ;;
    3.6)               maxversion=3.4; maxnumpyversion=1.20 ;;
    3.7|3.8|3.9|3.10)  maxversion=3.6; maxnumpyversion=1.22 ;;
    *)
